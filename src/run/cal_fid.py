...
def cal_fid(args, config):
    ...
    fid_score = trainer.cal_fid(args.dataset_type)
    LOGGER.info(colorstr('green', f'FID score: {fid_score}'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--load_model_type', type=str, default='last', required=False, choices=['loss', 'last'])
